...
const stylesByType = {
	...
	light: "text-gray-700 bg-white/80 hover:bg-gray-300",
	metamask: "text-white bg-metamask hover:bg-metamask/75",
	disabled: "cursor-not-allowed bg-white/10 text-white/20 pointer-events-none",
	"text-disabled":
		"cursor-not-allowed text-white/20 bg-transparent pointer-events-none leading-none",
};
