...
const Notification = ({ id, title = "", description, type = "success" }) => {
	...
	return (
		<div
			aria-live="assertive"
			className="relative w-[100%] inset-0 flex items-end px-4 py-3 pointer-events-none sm:items-start sm:p-3"
		>
			...
			<Transition
				...
				leaveTo="opacity-0"
			>
				<div className="w-full max-w-sm overflow-hidden border-2 rounded-lg shadow-xl pointer-events-auto bg-gray-950 ring-1 ring-black border-primary/40 ring-opacity-5">
					<div className="p-4">
