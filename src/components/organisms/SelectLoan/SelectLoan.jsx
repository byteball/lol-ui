...
import { calcStrikePrice, toLocalString } from "@/utils";
							...
							{value ? (
								<div className="relative flex flex-wrap basis-full">
									<div className="basis-1/2">
										<div className={cn("text-xs font-light leading-none mb-1")}>
											Collateral
										</div>
										<div
											className={cn(
												"font-semibold text-white text-sm leading-none"
											)}
										>
											{toLocalString(
								...
								<div className="text-white/60">Select your loan</div>
							)}
	...
	>
		{({ selected, active }) => (
			<>
				<div
					className={cn(
						"relative flex flex-wrap mb-2 basis-full py-2 pl-3 pr-9",
						disabled
